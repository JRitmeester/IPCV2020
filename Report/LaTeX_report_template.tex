...
\author{Ayham Alharbat,~\IEEEmembership{a.alharbat@student.utwente.nl,~2379589,~MSc EE-RAM}
		...
		~Protik Banerji,~\IEEEmembership{p.banerji@student.utwente.nl,s2342898,MSc S&C - RAM}
% <-this % stops a space
}
...
\begin{figure}[!t]
	\centering
\subfloat[Two ROIs]{\includegraphics[width=1.5in]{figures/Select2ROI.jpg}%
\label{fig_first_case}}
\subfloat[Three ROIs]{\includegraphics[width=1.5in]{figures/Select3ROI.jpg}%
\label{fig_second_case}}
\caption{Selecting ROIs: two ROIs are selected in (a) and three ROIs in (b)}
\label{select2ROI}
\end{figure}
...
The two matched points $a(x_1 , y_1)$ and $b(x_2 , y_2)$, expressed in pixels coordinates of their respected cameras, together with the parameters for the two cameras can be used to estimate the $(X, Y, Z)$ of this point in the world coordinates. 
\section{Results}
